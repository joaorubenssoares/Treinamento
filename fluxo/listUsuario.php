            ...
            <div class="panel panel-default">
			    ...
			    <div class="table-responsive">
			        <table class="table table-striped table-bordered table-hover">
						...
						$strSQL .= (strlen($_POST["fltEmail"]) <= 0)?"" :" AND DsEmail LIKE '%".mysql_real_escape_string($_POST["fltEmail"])."%'";				
						...
						{	
							...
							echo "<td class='center'>
								...
								<a href='mudaSenha.php' title='Mudar senha'>
									<img src='images/pass.png' alt='Mudar senha' />
								</a>
								<a href='cadUsuario.php?idUsuario={$objRow['idUsuario']}&acao= title='Excluir'>
